...
import { ActivitySquare, Trash2, Calendar as CalendarIcon, Plus, Droplets, BrainCircuit } from "lucide-react";
...
export default function HabitLogs() {
  ...
  const { register, handleSubmit, reset, watch } = useForm<HabitForm>({
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-2">
            <div>
              ...
              <div className="relative">
                ...
                <Input type="date" className="pl-11 border-purple-500/20 focus:border-purple-400 focus:ring-purple-400/20" {...register("date")} />
              </div>
            </div>
            ...
            >
              {createMutation.isPending ? "Saving..." : "Log Habits"}
            </button>
          </form>
        </PremiumCard>
      )}
