...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at 20% 20%, rgba(245,158,11,0.08) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(20,184,166,0.06) 0%, transparent 50%), #080d14",
      }}
    >
      {/* Glows */}
      <div className="absolute top-20 left-10 w-48 h-48 rounded-full blur-[80px] opacity-20 pointer-events-none"
        style={{ background: "radial-gradient(circle, #f59e0b, transparent)" }} />
      <div className="absolute bottom-20 right-10 w-48 h-48 rounded-full blur-[80px] opacity-15 pointer-events-none"
      ...
      {/* Card */}
      <div
        className="w-full max-w-sm rounded-3xl border border-white/10 p-7"
        style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div
              className="rounded-xl p-3 text-sm text-red-400 font-bold text-center border border-red-500/20"
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #f59e0b, #f97316)",
              boxShadow: loading ? "none" : "0 0 25px rgba(245,158,11,0.4)",
            }}
          >
            {loading ? (
