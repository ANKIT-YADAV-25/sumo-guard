...
import { Moon, Trash2, Calendar as CalendarIcon, Clock, Plus, Sparkles } from "lucide-react";
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <Input type="date" className="pl-11 border-teal-500/20 focus:border-teal-400 focus:ring-teal-400/20" {...register("date")} />
              </div>
            </div>
            ...
            return (
              <PremiumCard key={log.id} className={`p-4 flex justify-between items-center group border-l-4 ${currentStyle.split(' ')[0]} bg-slate-900/50`}>
                ...
                <div className="flex flex-col items-end gap-3">
                  ...
                  <button onClick={() => handleDelete(log.id)} className="text-white/20 hover:text-red-400 transition-colors p-1">
                    <Trash2 size={16} />
                  </button>
                </div>
              </PremiumCard>
